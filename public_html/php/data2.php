...
$query = "SELECT ROUND(SUM(potencia),3) AS preco, concat(hora,':00') as hora, CONCAT(`dia`,'-',`mes`,'-',`ano`) AS datas FROM medidasHora where mes>08 and dia>07 and dia<24 group by `dia`, `hora`";
