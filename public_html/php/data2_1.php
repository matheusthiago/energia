...
$query=sprintf("SELECT ROUND(SUM(potencia)*(0.62378769 ),2) AS preco, hora, CONCAT(dia,'-',mes,'-',ano) AS datas, ((STR_TO_DATE((CONCAT(ano,',',mes,',',dia,' ',hora)),'%Y,%m,%d %H'))) FROM medidasHora");
