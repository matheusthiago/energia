...
$query=sprintf("SELECT ROUND(SUM(potencia)*(0.62378769 ),2) AS preco, `hora`, STR_TO_DATE(CONCAT(`ano`,`mes`,`dia`,`hora`),'%Y%m%d%H') AS DATA FROM medidasHora GROUP BY `dia`, `hora`");
