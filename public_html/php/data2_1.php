...
$query=sprintf("SELECT ROUND(SUM(potencia)*(0.62378769 ),2) AS preco, `hora`, (CONCAT(`ano`,`mes`,`dia`,`hora`)) AS DATA, STR_TO_DATE('05/18/2009', '%m/%d/%Y') FROM medidasHora GROUP BY `dia`, `hora`");
